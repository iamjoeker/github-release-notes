...
/** Class retrieving GitHub information from the folder where .git is initialised. */
class GitHubInfo {
    /**
    ...
    *
    * @return {Promise} The promise that resolves repo information ({user: user, name: name})
    */
    _repo(callback) {
    ...
    * @param  {Function} callback
    *
    * @return {Promise} The promise that resolves token information ({token: token})
    */
    _token() {
